...
public final class NetworkUtils {
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm =
                    (TelephonyManager) Cxt.get().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) Cxt.get().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) Cxt.get().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) Cxt.get().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
     ...
     * @return 格式:460_03
     */
    public static String getPhoneMCC_MNC(Context context) {
        String value = "";
        if (context == null) {
            return value;
        }
